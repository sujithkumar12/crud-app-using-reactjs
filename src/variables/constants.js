...
export const strongPwd = /(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[^A-Za-z0-9])(?=.{8,})/;

export const nonstrongPwd = /(?=.*[a-z])(?=.*)(?=.*[0-9])(?=.*[^a-z0-9])(?=.{8,})/;

export const mediumPwd = /((?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[^A-Za-z0-9])(?=.{6,}))|((?=.*[a-z])(?=.*[A-Z])(?=.*[^A-Za-z0-9])(?=.{8,}))/;

export const date = /^[0-3]?[0-9].[0-3]?[0-9].(?:[0-9]{2})?[0-9]{2}$/;

export const website = /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&\'\(\)\*\+,;=.]+$/;

export const uploadURL = "https://vrittigroup.com:5000/data/uploads/";

export const MainURL = "https://a914-103-141-112-30.in.ngrok.io/api/user";
...
export const options = [
    ...
    { value: "TECHNICIAN - CHEMICAL CLEANING", label: "TECHNICIAN - CHEMICAL CLEANING" },
    ...
    { value: "FABRICATOR", label: "FABRICATOR" },
    { value: "ABRASIVE BLASTER / PAINTER CERTIFIED", label: "ABRASIVE BLASTER / PAINTER CERTIFIED", },
    ...
    { value: "MACHINE OPERATOR (TURNING/MILLING/DRILLING/GRINDING/SHAPER)", label: "MACHINE OPERATOR (TURNING/MILLING/DRILLING/GRINDING/SHAPER)", },
    { value: "FOREMAN-CIVIL", label: "FOREMAN-CIVIL" },
    { value: "MASON", label: "MASON" },
    { value: "CARPENTER", label: "CARPENTER" },
    { value: "AIR CONDITIONING MONITORING UNIT TECHNICIAN", label: "AIR CONDITIONING MONITORING UNIT TECHNICIAN", },
